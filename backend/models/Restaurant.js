...
const restaurantSchema=new mongoose.Schema({
  ...
  phone:String, website:String, social:{instagram:String,facebook:String,twitter:String}, openingHours:[hoursSchema], owner:{type:mongoose.Schema.Types.ObjectId,ref:'User'}, verified:{type:Boolean,default:false}, promoted:{type:Boolean,default:false}, nfcPublicId:{type:String,unique:true,sparse:true},
